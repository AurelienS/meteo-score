...
const SiteSelector: Component<SiteSelectorProps> = (props) => {
  ...
  return (
    <div class="w-full relative">
      ...
      <select
        id={selectId}
        class="block w-full px-4 py-2 min-h-[44px] border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors cursor-pointer relative z-10 appearance-auto"
